...
<link type='text/css' rel='stylesheet' href="css/votepage.css">
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>		
<script type='text/javascript' src="js/votepage.js"></script>
</head>
<body>
	<div class="container">
		<div class="clearfix">
			...
			<div class="row" id="bodyrow">				
				...
				<div class="col-xs-12 col-md-8" id="contents">
					<h1>발표자(<span class="meetnum">${requestScope.sheetNum}</span>회차)</h1>
					<hr>					
					<form role="form">																	
					</form>
					<div class="col-xs-12 col-md-6 col-md-offset-3">
						<button type="button" class="btn btn-primary btn-lg" id="votebtn" disabled>투표하기</button>
					</div>					
				</div>
			</div>					
		</div>
